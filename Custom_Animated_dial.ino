...
#define NEEDLE_LENGTH 60//35  // Visible length
#define NEEDLE_WIDTH  4  // Width of needle - make it an odd number
#define NEEDLE_RADIUS 60//90  // Radius at tip
#define NEEDLE_COLOR1 TFT_MAROON  // Needle periphery colour
#define NEEDLE_COLOR2 TFT_RED //TFT_RED     // Needle centre colour
...
void setup()   {
  ...
  spr_width = spr.textWidth("777"); //777 7 is widest numeral in this font
  ...
  spr.pushSprite(DIAL_CENTRE_X - spr_width / 2, 170 - spr.fontHeight() / 2);
  
  // Plot the label text
  tft.setTextColor(TFT_WHITE, bg_color);
  tft.setTextDatum(MC_DATUM);
  tft.drawString(" SPEED ", DIAL_CENTRE_X, DIAL_CENTRE_Y + 80, 2);   //+48
...
// =======================================================================================
// Loop   in this loop put Rotary Encoder input value for speed meter value
// =======================================================================================
void loop() {
...
void plotNeedle(int16_t angle, uint16_t ms_delay)
{
  ...
  while (angle != old_angle || !buffer_loaded) {
    ...
    spr.pushSprite(120 - spr_width / 2, 170 - spr.fontHeight() / 2);
